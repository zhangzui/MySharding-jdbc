...
public class TestRouteInterceptor implements Interceptor {
    ...
    static {
        try {
            ...
            started = true;
            DbContextHolder.setTableIndex("_001");
    ...
    private Object doProcess(Invocation invocation) throws InvocationTargetException, IllegalAccessException {
        Object proceed = null;
        try {
    ...
    private void interceptorStatement(Invocation invocation) {
        try {
    ...
    private void interceptorExcutor(Invocation invocation) {
